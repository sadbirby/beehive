...
public class SecurityConfig {
    ...
    private static final String[] AUTH_WHITELIST = {
            ...
            "/api/v1.0/login/authenticate", "/api/v1.0/user/forgot-password", "/api/v1.0/user/register", "/api/v1.0/user/check/**",
            // -- Swagger UI v3 (OpenAPI)
            "/v3/api-docs/**", "/swagger-ui/**", "/swagger-resources", "/swagger-resources/**", "/configuration/ui", "/configuration/security", "/swagger-ui.html", "/webjars/**",
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity.cors(cors -> cors.configurationSource(corsConfigurationSource())) // Disable CORS
                .csrf(AbstractHttpConfigurer::disable) // Disable CSRF protection
                .authorizeHttpRequests(auth -> auth.requestMatchers(AUTH_WHITELIST).permitAll() // Permit all requests to certain URLs
