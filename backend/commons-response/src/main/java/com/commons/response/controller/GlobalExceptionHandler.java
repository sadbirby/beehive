package com.commons.response.controller;

import com.commons.response.exception.*;
import com.commons.response.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(MediaConversionException.class)
    public ResponseEntity<ErrorResponse> handleInsufficientFunds(MediaConversionException ex) {
    ...
    private ErrorResponse err(String code, String message, String details) {
        return new ErrorResponse(new ErrorResponse.ErrorDetail(code, message, details));
    }
}
