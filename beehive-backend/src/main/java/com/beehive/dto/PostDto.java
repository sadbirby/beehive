...
public class PostDto {
    ...
    public PostDto(Long postId, String postTitle, String postBody, String postedBy, Date postedOn, Long numberOfLikes, Long numberOfReplies, Boolean isPostLikedByCurrentUser, Set<String> postLikedBy, Set<ReplyDto> postReplies) {
        this.postId = postId;
